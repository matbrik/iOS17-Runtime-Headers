...
// VNEntityIdentificationModelConfiguration (VNEntityIdentificationModelTrainedModelVIPv2Additions)

- (int)faceIDModelMaximumElementsPerID;

// VNEntityIdentificationModelConfiguration (VNEntityIdentificationModelTrainedModelVIPv3Additions)
