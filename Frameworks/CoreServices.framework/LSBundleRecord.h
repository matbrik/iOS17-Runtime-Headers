...
// LSBundleRecord (InfoPlistRarities)

- (id)UIBackgroundModes;
- (id)accentColorName;
- (id)privacyTrackingDomains;

// LSBundleRecord (Intents)
...
// LSBundleRecord (MobileInstallation)
...
// LSBundleRecord (IconServicesAdditions)
...
// LSBundleRecord (IntentsFoundation)
