...
// HKCoverageRecord (CategoryType)

- (long long)recordCategoryType;

// HKCoverageRecord (HKConceptIndexable)
...
// HKCoverageRecord (MedicalRecordCodings)

+ (id)defaultDisplayString;

- (id)medicalRecordCodings;

// HKCoverageRecord (SortDate)
