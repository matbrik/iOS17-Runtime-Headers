...
// HKSignedClinicalDataRecord (HKConceptIndexable)
...
// HKSignedClinicalDataRecord (HealthRecords)

- (id)recordIssuerDisplayName;
- (id)recordItemsDisplayName;
- (id)recordTypeDisplayName;

// HKSignedClinicalDataRecord (SortDate)
...
// HKSignedClinicalDataRecord (HDExtensions)
