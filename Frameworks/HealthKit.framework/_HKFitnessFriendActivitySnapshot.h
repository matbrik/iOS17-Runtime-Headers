...
@interface _HKFitnessFriendActivitySnapshot : HKSample <HDCoding, NSCopying> {
    double  _activeHours;
...
// _HKFitnessFriendActivitySnapshot (HDCodingSupport)
...
// _HKFitnessFriendActivitySnapshot (HDExtensions)
