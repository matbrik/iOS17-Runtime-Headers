...
@interface CNContactStore : NSObject <CHContactDataSource, EFLoggable, TUContactProvider, TUContactsDataSource, TUConversationContactProvider, TUHandleContactProvider> {
...
// CNContactStore (iOSAB)

- (id)addressBook;
- (id)iOSMapper;

// CNContactStore (iOSABLegacyCompatibility)
...
// CNContactStore (iOSABUnitTesting)

- (bool)setDefaultContainer:(id)arg1 forAccount:(id)arg2 error:(id*)arg3;

// CNContactStore (iOSPublicABCompatibilityCN)
...
// CNContactStore (PhotoLibraryAdditions)
...
// CNContactStore (TelephonyUtilities)
