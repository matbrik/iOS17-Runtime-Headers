...
// INIntent (INImageProxyInjecting)
...
// INIntent (InAppHandling)

- (bool)_intents_hasSystemIntentHandler;
- (bool)_intents_isExemptFromMulitWindowRequirementForInAppHandling;

// INIntent (NSExtensionContext)
...
// INIntent (_CDInteractionAdditions)
...
// INIntent (_CDSpotlightRecorderAdditions)
...
// INIntent (AudioSessionPreparation)

- (bool)ins_shouldPrepareAudioSession;

// INIntent (PrewarmAppAdditions)

- (bool)ins_shouldPrewarmApp;

// INIntent (SignalGatheringAdditions)
