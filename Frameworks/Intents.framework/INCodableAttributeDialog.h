...
// INCodableAttributeDialog (__INCodableAttributeDialogINIntentParameterDialogFormatString)

- (id)__INCodableDescriptionFormatStringKey;

// INCodableAttributeDialog (__INCodableAttributeDialogINIntentParameterDialogFormatStringDictionary)

- (id)__INCodableDescriptionFormatStringDictionaryKey;

// INCodableAttributeDialog (__INCodableAttributeDialogINIntentParameterDialogFormatStringDictionaryLanguageCode)

- (id)__INCodableDescriptionFormatStringDictionaryLanguageCodeKey;

// INCodableAttributeDialog (__INCodableAttributeDialogINIntentParameterDialogFormatStringID)

- (id)__INCodableDescriptionFormatStringIDKey;

// INCodableAttributeDialog (__INCodableAttributeDialogINIntentParameterDialogFormatStringLanguageCode)
