...
// INSendMessageIntent (DefaultResolutionResult)

- (void)_intents_resolveOutgoingMessageTypeWithCompletionHandler:(id /* block */)arg1;

// INSendMessageIntent (DeprecatedSendMessage)
...
// INSendMessageIntent (_CDInteractionAdditions)
...
// INSendMessageIntent (_CDSpotlightRecorderAdditions)
