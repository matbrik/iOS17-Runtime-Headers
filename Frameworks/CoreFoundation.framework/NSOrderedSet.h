...
@interface NSOrderedSet : NSObject <CKDeepCopying, NSCopying, NSFastEnumeration, NSMutableCopying, NSSecureCoding>
...
// NSOrderedSet (EmailFoundationAdditions)
...
// NSOrderedSet (IntentsFoundation)
