...
// CSSearchableItemAttributeSet (CSAddressBook_Private)

- (id)isZombie;
- (void)setIsZombie:(id)arg1;

// CSSearchableItemAttributeSet (CSAppDemotion_Private)
...
// CSSearchableItemAttributeSet (CSAttributes)
...
// CSSearchableItemAttributeSet (CSCoderAdditions)

- (void)encodeWithCSCoder:(id)arg1;
- (void)encodeWithCSCoder:(id)arg1 includeText:(bool)arg2;

// CSSearchableItemAttributeSet (CSCustomAttributes)

- (void)setValue:(id)arg1 forCustomKey:(id)arg2;
- (id)valueForCustomKey:(id)arg1;

// CSSearchableItemAttributeSet (CSDonatedEvent)

- (id)donatedEvent;
- (void)setDonatedEvent:(id)arg1;

// CSSearchableItemAttributeSet (CSEvent_Flight)
...
// CSSearchableItemAttributeSet (CSEvent_Hotel)
...
// CSSearchableItemAttributeSet (CSEvent_Restaurant)
...
// CSSearchableItemAttributeSet (CSFileProvider_Private)
...
// CSSearchableItemAttributeSet (CSInstantAnswer)

- (id)instantAnswers;
- (void)setInstantAnswers:(id)arg1;

// CSSearchableItemAttributeSet (CSInteraction_private)
...
// CSSearchableItemAttributeSet (CSMail_Private)
...
// CSSearchableItemAttributeSet (CSMessages_Private)
...
// CSSearchableItemAttributeSet (CSMotion)

- (id)lastMotionActivityState;
- (void)setLastMotionActivityState:(id)arg1;

// CSSearchableItemAttributeSet (CSNews_Private)

- (void)setTopic:(id)arg1;
- (id)topic;

// CSSearchableItemAttributeSet (CSPhotos_Private)
...
// CSSearchableItemAttributeSet (CSPortrait_Private)
...
// CSSearchableItemAttributeSet (CSPrivateAttributes)
...
// CSSearchableItemAttributeSet (CSQueryResultMatchingHint)

- (id)matchingHints;
- (void)setMatchingHints:(id)arg1;

// CSSearchableItemAttributeSet (CSSafari_Private)
...
// CSSearchableItemAttributeSet (CSWallet_Private)
...
// CSSearchableItemAttributeSet (Containment)
...
// CSSearchableItemAttributeSet (EventsExtras)

- (id)allDay;
- (void)setAllDay:(id)arg1;

// CSSearchableItemAttributeSet (SwiftUI_Archiving)
...
// CSSearchableItemAttributeSet (Temporary)
...
// CSSearchableItemAttributeSet (IC)
...
// CSSearchableItemAttributeSet (Shortcuts)
