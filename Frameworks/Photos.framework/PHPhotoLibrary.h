...
// PHPhotoLibrary (CloudIdentifiers)
...
// PHPhotoLibrary (DuplicateProcessing)
...
// PHPhotoLibrary (ImportDeDup)

- (id)uuid;

// PHPhotoLibrary (MediaProcessing)
...
// PHPhotoLibrary (MigrationDate)

- (id)migrationDate;

// PHPhotoLibrary (PHAdoptionUtilities)

- (id)pl_syncProgressAlbums;

// PHPhotoLibrary (PHBatchFetchingArray)
...
// PHPhotoLibrary (PNPhotoLibraryProtocol)
