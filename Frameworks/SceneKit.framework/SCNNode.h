...
@interface SCNNode : NSObject <NSCopying, NSSecureCoding, SCNActionable, SCNAnimatable, SCNBoundingVolume, SCNTransactionCommandObject, UIFocusItem> {
