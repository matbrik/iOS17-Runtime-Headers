...
@interface SCNScene : NSObject <DebugHierarchyObject_Fallback, NSSecureCoding, SCNTransactionCommandObject> {
...
// SCNScene (DebugHierarchyAdditionsFallback)
