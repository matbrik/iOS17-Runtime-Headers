...
- (void)snapAvatarPosterEditorFromFlowManager:(id)arg1 didUpdateContact:(id)arg2 withVisualIdentity:(id)arg3;
...
// CNMeCardSharingSettingsViewController (SafeCategory)
