...
@interface NSPersonNameComponents : NSObject <CKPropertiesDescription, NSCopying, NSSecureCoding> {
    id  _private;
}
...
// NSPersonNameComponents (ContactsPrivate)
...
// NSPersonNameComponents (FPAdditions)
...
// NSPersonNameComponents (BRAdditions)
