...
// _NSAttributedStringGrammarInflection (NSAttributedMarkdownParsing)

- (id)_initWithMarkdownDictionary:(id)arg1;
- (id)_markupDictionary;

// _NSAttributedStringGrammarInflection (NSAttributedStringInflectionAdditions)
...
// _NSAttributedStringGrammarInflection (NSExternalRepresentation)
...
// _NSAttributedStringGrammarInflection (NSInflectionPresets)
...
// _NSAttributedStringGrammarInflection (NSUserInflection)
...
// _NSAttributedStringGrammarInflection (_NSUserInflectionInternal)
