...
// NSMorphology (NSMorphologyConversionInternal)

- (id)initWithInflection:(id)arg1;

// NSMorphology (NSMorphologyUserSettings)

+ (id)userMorphology;

- (bool)isUnspecified;

// NSMorphology (NSMorphologyUserSettingsInternal)

+ (void)_getUserMorphology:(id*)arg1 userInflection:(id*)arg2;

// NSMorphology (NSMorphologyUserSettingsPrivate)
