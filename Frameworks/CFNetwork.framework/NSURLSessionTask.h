...
@interface NSURLSessionTask : NSObject <NSCopying, NSProgressReporting, RCOperationIdentifying, RCOperationPrioritizing> {
...
// NSURLSessionTask (ACSURLSession_Impl)
...
// NSURLSessionTask (RCAdditions)

- (id)rc_logIdentifier;

// NSURLSessionTask (RCOperationIdentifyingSupport)

- (id)longOperationDescription;
- (id)shortOperationDescription;

// NSURLSessionTask (RCOperationPrioritizingSupport)
