...
// EKEvent (EKObjectChangeSummarizer)
...
// EKEvent (AccessibilityUtilities)
...
// EKEvent (AttachmentUtils)

- (id)sortedEKAttachmentsDisplayStrings;

// EKEvent (AttendeeUtils)
