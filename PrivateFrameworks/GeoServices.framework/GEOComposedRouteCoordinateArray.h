...
// GEOComposedRouteCoordinateArray (Conversions)
...
// GEOComposedRouteCoordinateArray (PathMatching)
...
// GEOComposedRouteCoordinateArray (ProtoExtras)
...
// GEOComposedRouteCoordinateArray (Zilch)
