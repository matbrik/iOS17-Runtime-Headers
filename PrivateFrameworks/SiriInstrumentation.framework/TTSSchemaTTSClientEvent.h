...
// TTSSchemaTTSClientEvent (Component)
...
// TTSSchemaTTSClientEvent (InnerEventContainer)

- (id)innerEvent;

// TTSSchemaTTSClientEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// TTSSchemaTTSClientEvent (SensitiveConditions)
