...
// GRRSchemaGRRClientEvent (Component)
...
// GRRSchemaGRRClientEvent (InnerEventContainer)

- (id)innerEvent;

// GRRSchemaGRRClientEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// GRRSchemaGRRClientEvent (SensitiveConditions)
