...
// EXPSiriSchemaEXPSiriClientEvent (InnerEventContainer)

- (id)innerEvent;

// EXPSiriSchemaEXPSiriClientEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// EXPSiriSchemaEXPSiriClientEvent (SensitiveConditions)
