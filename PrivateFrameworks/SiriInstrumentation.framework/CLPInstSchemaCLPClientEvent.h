...
// CLPInstSchemaCLPClientEvent (Component)
...
// CLPInstSchemaCLPClientEvent (InnerEventContainer)

- (id)innerEvent;

// CLPInstSchemaCLPClientEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// CLPInstSchemaCLPClientEvent (SensitiveConditions)
