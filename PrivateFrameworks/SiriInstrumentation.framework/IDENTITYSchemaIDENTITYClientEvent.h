...
// IDENTITYSchemaIDENTITYClientEvent (Component)
...
// IDENTITYSchemaIDENTITYClientEvent (InnerEventContainer)

- (id)innerEvent;

// IDENTITYSchemaIDENTITYClientEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// IDENTITYSchemaIDENTITYClientEvent (SensitiveConditions)
