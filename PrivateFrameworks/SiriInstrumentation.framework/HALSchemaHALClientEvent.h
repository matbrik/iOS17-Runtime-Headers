...
// HALSchemaHALClientEvent (Component)
...
// HALSchemaHALClientEvent (InnerEventContainer)

- (id)innerEvent;

// HALSchemaHALClientEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// HALSchemaHALClientEvent (SensitiveConditions)
