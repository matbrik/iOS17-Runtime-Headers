...
// DODMLSchemaDODMLClientEvent (Component)

+ (int)joinability;

- (id)getComponentId;

// DODMLSchemaDODMLClientEvent (InnerEventContainer)

- (id)innerEvent;

// DODMLSchemaDODMLClientEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// DODMLSchemaDODMLClientEvent (SensitiveConditions)
