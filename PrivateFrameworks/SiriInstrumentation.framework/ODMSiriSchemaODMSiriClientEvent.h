...
// ODMSiriSchemaODMSiriClientEvent (InnerEventContainer)

- (id)innerEvent;

// ODMSiriSchemaODMSiriClientEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// ODMSiriSchemaODMSiriClientEvent (IsolationLevel)

- (int)clockIsolationLevel;

// ODMSiriSchemaODMSiriClientEvent (SensitiveConditions)
