...
// RFSchemaRFClientEvent (Component)
...
// RFSchemaRFClientEvent (InnerEventContainer)

- (id)innerEvent;

// RFSchemaRFClientEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// RFSchemaRFClientEvent (SensitiveConditions)
