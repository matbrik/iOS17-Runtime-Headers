...
// FLOWSchemaFLOWClientEvent (Component)
...
// FLOWSchemaFLOWClientEvent (InnerEventContainer)

- (id)innerEvent;

// FLOWSchemaFLOWClientEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// FLOWSchemaFLOWClientEvent (SensitiveConditions)
