...
// PEGASUSSchemaPEGASUSServerEvent (Component)
...
// PEGASUSSchemaPEGASUSServerEvent (InnerEventContainer)

- (id)innerEvent;

// PEGASUSSchemaPEGASUSServerEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// PEGASUSSchemaPEGASUSServerEvent (SensitiveConditions)
