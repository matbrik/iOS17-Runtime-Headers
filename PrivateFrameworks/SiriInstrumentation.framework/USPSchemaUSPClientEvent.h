...
// USPSchemaUSPClientEvent (Component)

+ (int)joinability;

- (id)getComponentId;

// USPSchemaUSPClientEvent (InnerEventContainer)

- (id)innerEvent;

// USPSchemaUSPClientEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// USPSchemaUSPClientEvent (SensitiveConditions)
