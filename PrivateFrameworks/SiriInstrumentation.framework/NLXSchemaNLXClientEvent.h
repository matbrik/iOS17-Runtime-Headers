...
// NLXSchemaNLXClientEvent (Component)
...
// NLXSchemaNLXClientEvent (InnerEventContainer)

- (id)innerEvent;

// NLXSchemaNLXClientEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// NLXSchemaNLXClientEvent (SensitiveConditions)
