...
// RFGSchemaRFGClientEvent (Component)

+ (int)joinability;

- (id)getComponentId;

// RFGSchemaRFGClientEvent (InnerEventContainer)

- (id)innerEvent;

// RFGSchemaRFGClientEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// RFGSchemaRFGClientEvent (SensitiveConditions)
