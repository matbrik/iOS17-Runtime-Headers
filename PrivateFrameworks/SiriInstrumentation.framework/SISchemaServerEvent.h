...
// SISchemaServerEvent (InnerEventContainer)

- (id)innerEvent;

// SISchemaServerEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// SISchemaServerEvent (SensitiveConditions)
