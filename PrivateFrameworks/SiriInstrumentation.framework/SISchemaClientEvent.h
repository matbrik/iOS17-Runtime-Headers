...
// SISchemaClientEvent (InnerEventContainer)

- (id)innerEvent;

// SISchemaClientEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// SISchemaClientEvent (SensitiveConditions)
