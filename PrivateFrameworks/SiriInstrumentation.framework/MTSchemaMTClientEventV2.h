...
// MTSchemaMTClientEventV2 (Component)

+ (int)joinability;

- (id)getComponentId;

// MTSchemaMTClientEventV2 (InnerEventContainer)

- (id)innerEvent;

// MTSchemaMTClientEventV2 (InstrumentationAdditions)

- (int)getAnyEventType;

// MTSchemaMTClientEventV2 (IsolationLevel)

- (int)clockIsolationLevel;

// MTSchemaMTClientEventV2 (SensitiveConditions)
