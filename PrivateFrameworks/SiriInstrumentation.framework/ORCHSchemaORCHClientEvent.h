...
// ORCHSchemaORCHClientEvent (Component)
...
// ORCHSchemaORCHClientEvent (InnerEventContainer)

- (id)innerEvent;

// ORCHSchemaORCHClientEvent (InstrumentationAdditions)

- (int)getAnyEventType;

// ORCHSchemaORCHClientEvent (SensitiveConditions)
