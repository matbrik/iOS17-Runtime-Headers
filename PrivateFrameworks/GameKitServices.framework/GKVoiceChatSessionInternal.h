...
// GKVoiceChatSessionInternal (GKSessionVoiceChatDelegate)
...
// GKVoiceChatSessionInternal (VideoConferenceChannelQualityDelegate)

- (int)calculateChannelQualities;
- (int)goodChannels;
- (void)lossRate:(float)arg1 forParticipantID:(id)arg2;

// GKVoiceChatSessionInternal (VideoConferenceSpeakingDelegate)

- (void)didStartSpeaking:(id)arg1;
- (void)didStopSpeaking:(id)arg1;

// GKVoiceChatSessionInternal (VoiceChatClient)
...
// GKVoiceChatSessionInternal (VoiceChatClientInternal)
