...
// NSTextAttachment (Accessibility)

- (id)accessibilityLabel;
- (void)setAccessibilityLabel:(id)arg1;

// NSTextAttachment (UIFoundation_UIKitAdditions)
...
// NSTextAttachment (CUIKPlatforms)

+ (id)cuik_textAttachmentWithImage:(id)arg1;

// Image: /Library/Developer/CoreSimulator/Volumes/iOS_21A328/Library/Developer/CoreSimulator/Profiles/Runtimes/iOS 17.0.simruntime/Contents/Resources/RuntimeRoot/System/Library/PrivateFrameworks/UIKitCore.framework/UIKitCore

// NSTextAttachment (UIAccessibilityContentSizeCategoryImageAdjusting)
...
// NSTextAttachment (UIImage)

+ (id)textAttachmentWithImage:(id)arg1;

// NSTextAttachment (UITextDragGeometry)
