...
// HDCloudSyncOperation (HDCloudSyncConditionalOperation)

- (id)operationWithRunCondition:(id /* block */)arg1;

// HDCloudSyncOperation (HDCloudSyncIgnoredErrorsOperation)

- (id)operationIgnoringErrors;

// HDCloudSyncOperation (HDCloudSyncOperationPipelineStage)
