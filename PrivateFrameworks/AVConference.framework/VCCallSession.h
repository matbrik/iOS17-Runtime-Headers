...
@interface VCCallSession : NSObject <AVCRateControllerDelegate, VCAudioIOSink, VCCaptionsReceiverDelegate, VCRedundancyControllerDelegate, VCSecureDataChannelDelegate, VCTransportSessionLegacyDelegate> {
...
// VCCallSession (SessionDelegate)

- (void)packMeters:(char *)arg1 withLength:(char *)arg2;

// VCCallSession (VCCaptionsReceiverDelegate)

- (void)didReceiveCaptions:(id)arg1;

// VCCallSession (VCRateControlMediaControllerDelegate)
...
// VCCallSession (VCSecureDataChannelDelegate)

- (void)vcSecureDataChannel:(id)arg1 messageType:(unsigned int)arg2 receivedData:(id)arg3;

// VCCallSession (VCTransportSessionLegacyDelegate)
...
// VCCallSession (VideoConferencing)
...
// VCCallSession (WCMClientDelegate)
