...
// VideoConference (AudioProcessing)
...
// VideoConference (NATDelegate)

- (void)NATTypeDictionaryUpdated:(id)arg1;
- (void)triggerInterfaceChange;

// VideoConference (PrivateMethods)
...
// VideoConference (SessionDelegate)
...
// VideoConference (VideoProcessing)
