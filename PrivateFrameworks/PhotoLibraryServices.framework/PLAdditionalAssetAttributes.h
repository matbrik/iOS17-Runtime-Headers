...
// PLAdditionalAssetAttributes (CloudRecoveryState)
...
// PLAdditionalAssetAttributes (DescriptionAccessors)

- (id)longDescription;
- (void)setLongDescription:(id)arg1;

// PLAdditionalAssetAttributes (ExtraDurationData)
...
// PLAdditionalAssetAttributes (MetadataAccessors)

- (id)mediaMetadataData;
- (void)setMediaMetadataData:(id)arg1;

// PLAdditionalAssetAttributes (MomentShare)
...
// PLAdditionalAssetAttributes (PLDuplicateAsset)

- (id)duplicateSortPropertyNames;
- (id)duplicateSortPropertyNamesSkip;

// PLAdditionalAssetAttributes (PLJournalEntryPayload)

- (id)payloadForChangedKeys:(id)arg1;
- (id)payloadID;

// PLAdditionalAssetAttributes (Sceneprint)
...
// PLAdditionalAssetAttributes (SpatialOverCapture)
