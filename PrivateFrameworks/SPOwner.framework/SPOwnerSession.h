...
// SPOwnerSession (MaintenanceConnection)
...
// SPOwnerSession (PersistentConnection)
...
// SPOwnerSession (SeparationMonitoring)
...
// SPOwnerSession (TrackingAvoidance)
