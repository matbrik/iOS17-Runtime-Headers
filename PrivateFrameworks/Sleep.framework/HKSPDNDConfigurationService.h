...
@interface HKSPDNDConfigurationService : NSObject <DNDGlobalConfigurationServiceListener, DNDModeConfigurationServiceListener, HKSPDiagnosticsProvider, HKSPSleepFocusModeBridge> {
