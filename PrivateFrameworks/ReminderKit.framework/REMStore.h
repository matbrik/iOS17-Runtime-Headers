...
// REMStore (AccountManagement_Internal)
...
// REMStore (AccountManagement_PrivateSPIs)
...
// REMStore (ChangeTrackingProvider_IntegrationTestsOnlyAPIsSupport)

- (id)provideAnonymousChangeTrackingWithTransactionAuthorKeysToExclude:(id)arg1;

// REMStore (ChangeTrackingSupport)
...
// REMStore (EventKitCompatibility)
...
// REMStore (ReplicaManagerProviders)
