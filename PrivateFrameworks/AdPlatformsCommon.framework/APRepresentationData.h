...
@property (nonatomic, readonly) NSArray *cppIds;
...
@property (nonatomic, readonly) NSDictionary *positionInformation;
...
@property (nonatomic, readonly) long long slotNumber;
