...
// UITextField (_UIInteractionStateRestorable)

- (id)_interactionState;
- (void)_setInteractionState:(id)arg1;

// UITextField (_UIKitLayoutSpacing)
...
// UITextField (DebugHierarchyAdditionsFallback)
