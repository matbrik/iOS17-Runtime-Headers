...
@interface UIWindow : UIView <DebugHierarchyEntryPoint_Fallback, NSISEngineDelegate, _UIContextBindable, _UIFocusEventRecognizerDelegate, _UIFocusMovementActionForwarding, _UIForcedOrientationTransactionHandler, _UIOrientationDebugDescriptionProviding, _UIPassthroughScrollInteractionDelegate> {
...
// UIWindow (UIActivityItemsConfiguration)
...
// UIWindow (UIKitOrientationDebugging)
...
// UIWindow (UIRemoteInputViewInfoAdditions)

- (bool)_isRemoteInputHostWindow;

// UIWindow (UISystemStatusUISupport)

- (id)_StatusBar_fbsScene;

// UIWindow (UITextEffectsOrdering)
...
// UIWindow (UITextEffectsWindowSpringBoardOnly)

- (id)_hostingWindow;

// UIWindow (ViewService)
...
// UIWindow (_UISystemGestureWindow_Internal)
...
- (bool)_axShouldPostScreenChangeOnOrderFront:(bool)arg1;
...
// UIWindow (AVAdditions_Internal_Mobile)
...
// UIWindow (UIAccessibilityElementTraversal)
...
// UIWindow (DebugHierarchyAdditionsFallback)
