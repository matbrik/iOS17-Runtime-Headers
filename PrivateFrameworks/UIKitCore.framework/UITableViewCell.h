...
@interface UITableViewCell : UIView <DebugHierarchyObject_Fallback, NSCoding, UIEditMenuInteractionDelegate, UIGestureRecognizerDelegate, UIScrollViewDelegate, UITableConstantsCellProviding, _UIInteractiveHighlighting, _UISystemBackgroundViewContainer> {
...
// UITableViewCell (UIAccessibility)
...
// UITableViewCell (DebugHierarchyAdditionsFallback)
