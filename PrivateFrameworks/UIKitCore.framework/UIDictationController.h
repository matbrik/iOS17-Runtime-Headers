...
@interface UIDictationController : NSObject <UIAdaptivePresentationControllerDelegate, UIDictationConnectionDelegate, UIDictationConnectionTokenFilterProtocol, _UIDictationPrivacySheetControllerDelegate, _UITextInputUserInteractionDelegate, _UITouchPhaseChangeDelegate> {
...
// UIDictationController (SafeCategory)
