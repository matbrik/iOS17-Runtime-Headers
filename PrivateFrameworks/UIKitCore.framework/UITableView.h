...
- (void)_axUpdateSelectedBackgroundVisibilityForCell:(id)arg1 visible:(bool)arg2;
...
// UITableView (CrossPlatformDefinitions)
...
// UITableView (DebugHierarchyAdditionsFallback)
