...
@interface UINavigationController : UIViewController <DebugHierarchyObject_Fallback, UIGestureRecognizerDelegatePrivate, UILayoutContainerViewDelegate, _UINavigationBarDelegatePrivate, _UIScrollViewScrollObserver, _UITVScrollViewManagerDelegate, _UIToolbarDelegateInternal> {
...
// UINavigationController (ForUISplitViewController)

- (bool)_isNavigationController;
- (id)_navigationBarForDragAffordance;
- (void)_stopTransitionsImmediately;

// UINavigationController (UIActivityItemsConfiguration)
...
// UINavigationController (UIKitOnMac)
...
// UINavigationController (SafeCategory)
...
// UINavigationController (PSControllerAdditions)
...
// UINavigationController (DebugHierarchyAdditionsFallback)
