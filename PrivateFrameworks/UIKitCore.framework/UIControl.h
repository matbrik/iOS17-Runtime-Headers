...
@interface UIControl : UIView <UIContextMenuInteractionDelegate, UIContextMenuInteractionDelegate_Private, UIPointerInteractionDelegate, _UIVariableGestureContextMenuInteractionDelegate> {
    struct { 
...
// UIControl (MKCrossPlatformOperations)
...
// UIControl (DebugHierarchyAdditionsFallback)
