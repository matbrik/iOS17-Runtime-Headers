...
@interface UIApplication : UIResponder <DebugHierarchyEntryPoint_Fallback, DebugHierarchyObject_Fallback, FBSDisplayLayoutObserver, FBSWorkspaceDelegate, FBSWorkspaceDelegate_Exiting, PKPushRegistryDelegate, UIActivityContinuationManagerApplicationContext, UIApplicationSnapshotPreparing, UIRepeatedActionDelegate, UIStatusBarStyleDelegate_SpringBoardOnly, _UIApplicationInitializationContextFactory, _UIWindowSceneActivator_Internal> {
...
// UIApplication (ExtensionBehavior)

+ (bool)_wantsApplicationBehaviorAsExtension;

// UIApplication (SessionAndConfigurationInternal)
...
// UIApplication (UIKitApplicationAccessibilityInternal)

+ (void)_accessibilityLoadSettingsLoaderIfNeeded;

// UIApplication (_UIDragging_Private)

- (bool)_canAnimateDragCancelInApp;

// UIApplication (_UIWindowSceneActivationCommon)
...
- (bool)_accessibilityDispatchScrollWithAmount:(long long)arg1;
- (bool)_accessibilityElementBelongsToKeyboardWindow:(id)arg1;
- (id)_accessibilityElementCommunityIdentifier;
- (id)_accessibilityElementFirst:(bool)arg1 last:(bool)arg2 forFocus:(bool)arg3 allowScrolling:(bool)arg4 parameters:(id)arg5;
- (id)_accessibilityElementFirst:(bool)arg1 last:(bool)arg2 forFocus:(bool)arg3 allowScrolling:(bool)arg4 traversalOptions:(id)arg5;
- (id)_accessibilityElementFirst:(bool)arg1 last:(bool)arg2 forFocus:(bool)arg3 parameters:(id)arg4;
...
- (id)_accessibilityMainWindowInWindows:(id)arg1;
...
- (void)_accessibilitySetSpeakThisRootElement:(id)arg1;
- (void)_accessibilitySetSpeakThisRootElementAccessibilityIdentifier:(id)arg1;
- (void)_accessibilitySetSpeakThisSceneIdentifierRequestedForActiveSpeakScreenSession:(id)arg1;
- (void)_accessibilitySetSpeakThisViewsFromSceneRequestedForActiveSpeakScreenSession:(id)arg1;
...
- (id)_accessibilityStatusBarElements:(bool)arg1 sorted:(bool)arg2;
...
- (id)_accessibilityWindowSceneForSceneID:(id)arg1;
...
- (void)_addEntriesToMapTable:(id)arg1 fromMapTable:(id)arg2;
- (id)_axAllSubviews;
- (id)_axSubviews;
...
// UIApplication (MKLookAroundExtras)
...
// UIApplication (AXFrontBoardExtras)
...
// UIApplication (RPTCatalystAdditions)
...
// UIApplication (DebugHierarchyAdditionsFallback)
