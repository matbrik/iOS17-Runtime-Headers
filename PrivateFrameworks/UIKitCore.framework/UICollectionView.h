...
@interface UICollectionView : UIScrollView <DebugHierarchyObject_Fallback, UIDataSourceTranslating, _UICollectionTableIndexOverlayHost, _UICollectionViewSubviewManagerDelegate, _UIDataSourceBackedView, _UIHorizontalIndexTitleBarDelegate, _UIKeyboardAutoRespondingScrollView, _UISelectionInteractionDelegate, _UIUpdateCycleIdleObserver> {
...
// UICollectionView (_UIKitIsUICollectionView)
...
- (id)_accessibilityLayoutAttributesForSupplementaryHeaderViewAtIndexPath:(id)arg1;
...
- (void)setAccessibilityComparatorForSorting:(id /* block */)arg1;
...
// UICollectionView (SwiftUITesting_Swizzles)
...
// UICollectionView (DebugHierarchyAdditionsFallback)
