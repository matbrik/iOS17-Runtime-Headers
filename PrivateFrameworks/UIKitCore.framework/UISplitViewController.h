...
@interface UISplitViewController : UIViewController <DebugHierarchyObject_Fallback, UIViewControllerStatusBarPartStyleProvider, _UIVisualStyleStylable> {
...
// UISplitViewController (SlidingBars)
...
// UISplitViewController (UIActivityItemsConfiguration)
...
// UISplitViewController (SafeCategory)
...
// UISplitViewController (DebugHierarchyAdditionsFallback)
