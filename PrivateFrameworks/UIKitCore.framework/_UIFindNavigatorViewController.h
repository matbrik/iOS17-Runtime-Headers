...
- (void)_axAnnounceReplacementWithPreviousResultCount:(long long)arg1 previousIndex:(long long)arg2;
- (void)_axReloadElementRelations:(bool)arg1;
...
// _UIFindNavigatorViewController (SafeCategory)
