...
@interface UISearchController : UIViewController <DebugHierarchyObject_Fallback, NSCoding, UIGestureRecognizerDelegate, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate, _UIScrollViewScrollObserver_Internal> {
...
// UISearchController (SafeCategory)
...
// UISearchController (DebugHierarchyAdditionsFallback)
