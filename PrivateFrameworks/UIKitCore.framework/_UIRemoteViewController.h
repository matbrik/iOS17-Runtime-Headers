...
// _UIRemoteViewController (_UIKitIsUIRemoteViewController)
...
- (void)_accessibilityRemoteView:(id)arg1 pid:(int)arg2 machPort:(unsigned int)arg3;
...
- (void)_axSetMachPortRetrievalTimer:(id)arg1;
- (void)_axSetWasFocusEnabled:(bool)arg1;
- (void)_axTakeBakeFocusWithHeading:(id)arg1;
- (id)disconnect;

// _UIRemoteViewController (SafeCategory)
