...
@interface UICollectionViewController : UIViewController <DebugHierarchyObject_Fallback, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewFocusDelegate_Legacy, UIGestureRecognizerDelegate, UIViewControllerPreviewingDelegate, UIViewControllerPreviewingDelegate_Deprecated, _UIKeyboardAutoRespondingScrollViewController> {
...
// UICollectionViewController (DebugHierarchyAdditionsFallback)
