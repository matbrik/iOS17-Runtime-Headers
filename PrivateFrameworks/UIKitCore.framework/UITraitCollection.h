...
// UITraitCollection (UILargeContentViewerInternal)

- (bool)_isLargeContentViewerEnabled;

// UITraitCollection (_UIFallbackEnvironment)
...
// UITraitCollection (SwiftUIStaging)
...
// UITraitCollection (PRXUITraitCollectionExtras)
