...
@interface UIActivityIndicatorView : UIView <DebugHierarchyObject_Fallback, NSCoding, UIActivityIndicatorProvider, _UIVisualStyleStylable> {
...
// UIActivityIndicatorView (SafeCategory)
...
// UIActivityIndicatorView (DebugHierarchyAdditionsFallback)
