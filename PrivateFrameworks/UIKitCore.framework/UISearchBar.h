...
@interface UISearchBar : UIView <DebugHierarchyObject_Fallback, UIBarPositioning, UILookToDictateCapable, UIScribbleInteractionDelegate, UITextInputTraits, UITextInputTraits_Private, _UIBarPositioningInternal, _UINavigationBarAugmentedTitleView> {
...
// UISearchBar (ForTVOSOnly)

- (bool)_forceLegacyVisual;
- (void)_setForceLegacyVisual:(bool)arg1;

// UISearchBar (ModernSearchControllerTV)
...
// UISearchBar (SPIv2Compatibility)
...
// UISearchBar (TokenSPIToBecomeAPI)
...
// UISearchBar (DebugHierarchyAdditionsFallback)

+ (id)fallback_debugHierarchyPropertyDescriptions;
+ (id)fallback_debugHierarchyValueForPropertyWithName:(id)arg1 onObject:(id)arg2 outOptions:(id*)arg3 outError:(id*)arg4;

// UISearchBar (DebugHierarchyHelpers)
