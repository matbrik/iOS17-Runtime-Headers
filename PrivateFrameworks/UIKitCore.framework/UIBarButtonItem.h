...
@interface UIBarButtonItem : UIBarItem <DebugHierarchyObject_Fallback, NSCoding, UIMenuForcedAutomaticSelectionDelegate, _UIPopoverPresentationControllerSourceItem_Internal> {
...
// UIBarButtonItem (_UIPopoverPresentationControllerSourceItem_Internal)
...
// UIBarButtonItem (DOCAdditions)

- (bool)_doc_isRemoteBarItemForUUID:(id)arg1;

// UIBarButtonItem (DOC_IPI_Usage_103371117)

- (id)_doc_ipi_view;
- (void)set_doc_ipi_view:(id)arg1;

// UIBarButtonItem (DOC_IPI_Usage_103371211)
...
// UIBarButtonItem (DOC_IPI_Usage_103371245)
...
// UIBarButtonItem (AXPrivCategory)
...
// UIBarButtonItem (DebugHierarchyAdditionsFallback)
