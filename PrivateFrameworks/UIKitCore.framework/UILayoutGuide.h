...
@interface UILayoutGuide : NSObject <AVKitLayoutItem, DebugHierarchyObject_Fallback, NSCoding, NSISVariableDelegate, UILayoutItem_Internal, _UILayoutItem, _UIPopoverPresentationControllerSourceItem_Internal> {
...
// UILayoutGuide (StatusBarAdditions_Internal)
...
// UILayoutGuide (_UIPopoverPresentationControllerSourceItem_Internal)
...
// UILayoutGuide (DebugHierarchyAdditionsFallback)
