...
// UISegmentedControl (_UIKitBaselineConstraintSupport)
...
// UISegmentedControl (SafeCategory)
...
// UISegmentedControl (MKCrossPlatformOperations)
...
// UISegmentedControl (DebugHierarchyAdditionsFallback)

+ (id)fallback_debugHierarchyPropertyDescriptions;
+ (id)fallback_debugHierarchyValueForPropertyWithName:(id)arg1 onObject:(id)arg2 outOptions:(id*)arg3 outError:(id*)arg4;

// UISegmentedControl (DebugHierarchyHelpers)
