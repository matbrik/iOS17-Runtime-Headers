...
@interface UITabBarItem : UIBarItem <DebugHierarchyObject_Fallback, _UIBarAppearanceChangeObserver, _UIPopoverPresentationControllerSourceItem_Internal> {
...
// UITabBarItem (_UIPopoverPresentationControllerSourceItem_Internal)
...
// UITabBarItem (DebugHierarchyAdditionsFallback)
