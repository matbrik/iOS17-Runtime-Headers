...
// UIPickerView (UICatalystMacIdiomUnsupported_Internal)

+ (bool)_allowsUnsupportedMacIdiomBehavior;
+ (void)_setAllowsUnsupportedMacIdiomBehavior:(bool)arg1;

// UIPickerView (_UIPickerViewScrollTesting)
...
// UIPickerView (DebugHierarchyAdditionsFallback)
