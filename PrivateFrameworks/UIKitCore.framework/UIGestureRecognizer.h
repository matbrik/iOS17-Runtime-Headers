...
@interface UIGestureRecognizer : NSObject <_UIEventRespondable, _UIExcludable, _UIForceLevelClassifierDelegate, _UIPressesEventRespondable, _UITouchesEventRespondable> {
...
// UIGestureRecognizer (UITextInteraction)

- (id)_pairedGestureIdentifiers;
- (id)_pairedGestureIdentifiersAndCreate:(bool)arg1;

// UIGestureRecognizer (_UISystemGestureManager)
...
// UIGestureRecognizer (WKContentViewHelpers)
