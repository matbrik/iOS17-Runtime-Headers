...
// MCProfileConnection (AirPrint)

- (id)knownAirPrintIPPURLStrings;

// MCProfileConnection (AppWhitelist)
...
// MCProfileConnection (CloudConfiguration)
...
// MCProfileConnection (ManagedOpenIn)
...
// MCProfileConnection (SafariBookmarks)
...
// MCProfileConnection (SingleAppMode)
