...
@interface CSSpeechController : NSObject <CSAudioAlertProvidingDelegate, CSAudioConverterDelegate, CSAudioDecoderDelegate, CSAudioSessionControllerDelegate, CSAudioSessionProvidingDelegate, CSAudioStreamProvidingDelegate, CSContinuousVoiceTriggerDelegate, CSEndpointAnalyzerImplDelegate, CSLanguageCodeUpdateMonitorDelegate, CSSmartSiriVolumeControllerDelegate, CSSpeechManagerDelegate, CSXPCClientDelegate, SOClockAlarmListening, SOClockTimerListening, SOMediaNowPlayingListening> {
