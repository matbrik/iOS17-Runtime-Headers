...
// CPLRecordChange (CPLPlaceholderRecord)

+ (Class)relatedRecordClass;

- (Class)relatedRecordClass;

// CPLRecordChange (CPLPushSessionTracker)

- (bool)validateRecordForTracker:(id)arg1;

// CPLRecordChange (CPLRecordView)
