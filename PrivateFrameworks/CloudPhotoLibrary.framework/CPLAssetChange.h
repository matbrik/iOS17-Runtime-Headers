...
// CPLAssetChange (CPLPlaceholderRecord)

+ (Class)relatedRecordClass;

// CPLAssetChange (CPLPushSessionTracker)

- (bool)validateRecordForTracker:(id)arg1;

// CPLAssetChange (DefaultsSupport)
...
// CPLAssetChange (PLCloudBatchDownloader)
