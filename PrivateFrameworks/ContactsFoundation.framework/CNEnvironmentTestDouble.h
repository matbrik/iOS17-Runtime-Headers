...
// CNEnvironmentTestDouble (CNKeyboardStateMonitor)

- (void)setKeyboardStateMonitor:(id)arg1;

// CNEnvironmentTestDouble (Contacts)
...
// CNEnvironmentTestDouble (Autocomplete)
...
// CNEnvironmentTestDouble (ContactsMetrics)
...
// CNEnvironmentTestDouble (CoreRecents)
