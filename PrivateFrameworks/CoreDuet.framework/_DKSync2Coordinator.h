...
// _DKSync2Coordinator (APSConnectionDelegate)

- (void)connection:(id)arg1 didReceiveIncomingMessage:(id)arg2;
- (void)connection:(id)arg1 didReceivePublicToken:(id)arg2;

// _DKSync2Coordinator (_DKKnowledgeStorageEventNotificationDelegate)
...
// _DKSync2Coordinator (_DKSyncRemoteKnowledgeStorageFetchDelegate)
