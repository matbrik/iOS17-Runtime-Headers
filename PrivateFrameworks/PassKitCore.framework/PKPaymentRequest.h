...
// PKPaymentRequest (PKAccountServiceTransferRequestSubclassAdditions)

- (id)accountServiceTransferRequest;
- (bool)isAccountServiceTransferRequest;

// PKPaymentRequest (PKDisbursementPaymentRequestSubclassAdditions)

- (id)disbursementPaymentRequest;

// PKPaymentRequest (PKPayLaterPaymentRequestSubclassAdditions)

- (bool)isPayLaterPaymentRequest;
- (id)payLaterPaymentRequest;

// PKPaymentRequest (PKPaymentRequestSubclassAdditions)

- (bool)isServiceProviderPaymentRequest;
- (id)serviceProviderPaymentRequest;

// PKPaymentRequest (PKPeerPaymentRequestSubclassAdditions)

- (bool)isPeerPaymentRequest;
- (id)peerPaymentRequest;

// PKPaymentRequest (PKVirtualCardEnrollmentRequestSubclassAdditions)
