...
@interface PKPaymentProvisioningController : NSObject <CLLocationManagerDelegate, PKAccountServiceObserver, PKPaymentServiceDelegate, PKPaymentWebServiceDelegate> {
...
// PKPaymentProvisioningController (PKSuppressDefaultCardholderNameFieldAdditions)
