...
// PSListController (AppearanceProviderExtensions)
...
// PSListController (CustomizationExtras)

- (id)unprotectedSpecifiers;

// PSListController (NavigationCoordination)
...
// PSListController (PasscodeAdditions)
...
// PSListController (AXUISettingsAdditions)
