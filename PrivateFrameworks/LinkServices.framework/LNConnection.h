...
// LNConnection (FetchActionAppContext)

- (void)fetchActionAppContextForAction:(id)arg1 completionHandler:(id /* block */)arg2;

// LNConnection (FetchActionForAutoShortcutPhrase)
...
// LNConnection (FetchOptionsDefaultValue)
...
// LNConnection (FetchSuggestedActions)
...
// LNConnection (PerformQuery_Deprecated)
