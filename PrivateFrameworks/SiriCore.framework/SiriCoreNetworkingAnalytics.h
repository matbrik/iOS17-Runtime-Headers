...
// SiriCoreNetworkingAnalytics (NetworkConnectionState)
...
// SiriCoreNetworkingAnalytics (SessionConnectionFail)
...
// SiriCoreNetworkingAnalytics (SessionConnectionSnapshot)
