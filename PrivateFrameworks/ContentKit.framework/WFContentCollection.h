...
// WFContentCollection (NSExtensionItem)

- (id)extensionItems;
- (id)minimalExtensionItems;

// WFContentCollection (RichTextGeneration)

- (void)getRichTextRepresentation:(id /* block */)arg1;

// WFContentCollection (Transform)
