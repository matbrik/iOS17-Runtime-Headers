...
- (struct CGPoint { double x1; double x2; })_accessibilityMapViewPointForZoomPoint:(struct CGPoint { double x1; double x2; })arg1;
...
- (struct { double x1; double x2; })accessibilityConvertScreenPointToCoordinate:(struct CGPoint { double x1; double x2; })arg1;
...
- (id)accessibilityIntersectorsForRoad:(id)arg1 withPoint:(struct CGPoint { double x1; double x2; })arg2;
...
- (void)accessibilitySetMapZoomLevel:(double)arg1 center:(struct { double x1; double x2; })arg2 yaw:(double)arg3 completionHandler:(id /* block */)arg4;
...
- (bool)accessibilityZoom:(double)arg1 point:(struct CGPoint { double x1; double x2; })arg2 animated:(bool)arg3 completionHandler:(id /* block */)arg4;
- (bool)accessibilityZoom:(double)arg1 point:(struct CGPoint { double x1; double x2; })arg2 completionHandler:(id /* block */)arg3;
