...
// AFMultiUserStateSnapshot (AFMultiUserStateSnapshotMutability)

- (id)mutatedCopyWithMutator:(id /* block */)arg1;

// AFMultiUserStateSnapshot (Additions)

- (id)initWithConfidenceScores:(id)arg1;
- (id)initWithVtSatScore:(id)arg1;

// AFMultiUserStateSnapshot (ContextSnapshot)

- (id)initWithSerializedBackingStore:(id)arg1;
- (id)serializedBackingStore;

// AFMultiUserStateSnapshot (ShortDescription)
