...
// BRCAccountSession (BRCContainerFindByName)
...
// BRCAccountSession (BRCSyncContext)
...
// BRCAccountSession (BRCZoneMigration)

- (void)scheduleZoneMovesToCloudDocs:(id)arg1;

// BRCAccountSession (DatabaseAdditions)
...
// BRCAccountSession (LegacyAdditions)
