...
// SGSqlEntityStore (CNtoSGContacts)
...
// SGSqlEntityStore (ContactDetails)
...
// SGSqlEntityStore (ContentProtection)
...
// SGSqlEntityStore (DatabaseCheck)
...
// SGSqlEntityStore (DatabaseMigrator)
...
// SGSqlEntityStore (NaiveBayesModel)
...
// SGSqlEntityStore (ReimportRequests)
...
// SGSqlEntityStore (SerializedContacts)
...
// SGSqlEntityStore (SpotlightMapping)
...
// SGSqlEntityStore (SpotlightMapping_Internal)

- (id)uniqueIdentifierForMessageId:(id)arg1;

// SGSqlEntityStore (SqlHelpers)
...
// SGSqlEntityStore (StatsCounters)
