...
@interface STTelephonyStateProvider : NSObject <BSDebugDescriptionProviding, BSInvalidatable, CoreTelephonyClientCarrierBundleDelegate, CoreTelephonyClientDataDelegate, CoreTelephonyClientDelegate, CoreTelephonyClientRegistrationDelegate, CoreTelephonyClientSubscriberDelegate, CoreTelephonyClientSuppServicesDelegate, RadiosPreferencesDelegate> {
