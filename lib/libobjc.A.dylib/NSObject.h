...
// NSObject (AXCollectionViewOverrides)

- (void)accessibilityClearInternalData;

// NSObject (AXTablePriv)

- (long long)_accessibilityScrollPositionForCellOverride:(long long)arg1;

// NSObject (EmojiCompare)

- (long long)_emojiCompare:(id)arg1;

// Image: /Library/Developer/CoreSimulator/Volumes/iOS_21A328/Library/Developer/CoreSimulator/Profiles/Runtimes/iOS 17.0.simruntime/Contents/Resources/RuntimeRoot/System/Library/AccessibilityBundles/WebKitLegacy.axbundle/WebKitLegacy

// NSObject (WebViewAccessibilityAdditions)
...
// NSObject (AVPlayerController_WebKitAdditions)
...
// NSObject (LegacyModelObjectProviding)

- (id)musicKit_sanitizedLegacyModelObject;

// NSObject (MusicKit_SoftLinking_MPArtworkCatalog)
...
// NSObject (MusicKit_SoftLinking_MPArtworkColorAnalysis)
...
// NSObject (MusicKit_SoftLinking_MPIdentifierSet)
...
// NSObject (MusicKit_SoftLinking_MPModelInnerObjectProviding)

- (id)_musicKit_innerModelObject;
- (id)musicKit_innerModelObject;

// NSObject (MusicKit_SoftLinking_MPModelObject_Artwork)

- (id)musicKit_artworkCatalogForProperty:(id)arg1;

// NSObject (MusicKit_SoftLinking_MPNowPlayingInfoAudioFormat)

- (id)_musicKit_self_nowPlayingInfoAudioFormat;
- (long long)musicKit_nowPlayingInfoAudioFormat_badging;

// NSObject (StorageDictionaryProvider)
...
// NSObject (SwiftUIAccessibilityPrivate)
...
// NSObject (NSObjectAccessibilityUI)
...
// NSObject (BSXPCObjectUtilitiesIndirect)
...
// NSObject (KGPropertyTypeProtocol)
...
// NSObject (MRAdditionsFormatting)
...
// NSObject (MusicKit_SoftLinking_MPAVRoute)

- (id)_musicKit_self_avRoute;
- (id)musicKit_avRoute_routeName;
- (id)musicKit_avRoute_routeUID;

// NSObject (MusicKit_SoftLinking_MPCPlayerActionAtQueueEndCommand)
...
// NSObject (MusicKit_SoftLinking_MPCPlayerChangeItemCommand)
...
// NSObject (MusicKit_SoftLinking_MPCPlayerCommandRequest)
...
// NSObject (MusicKit_SoftLinking_MPCPlayerInsertItemsCommand)
...
// NSObject (MusicKit_SoftLinking_MPCPlayerPath)
...
// NSObject (MusicKit_SoftLinking_MPCPlayerReorderItemsCommand)
...
// NSObject (MusicKit_SoftLinking_MPCPlayerRepeatCommand)

- (id)_musicKit_self_repeatCommand;
- (id)musicKit_repeatCommand_setRepeatType:(long long)arg1;

// NSObject (MusicKit_SoftLinking_MPCPlayerResetTracklistCommand)
...
// NSObject (MusicKit_SoftLinking_MPCPlayerResponse)
...
// NSObject (MusicKit_SoftLinking_MPCPlayerResponseItem)
...
// NSObject (MusicKit_SoftLinking_MPCPlayerResponseTracklist)
...
// NSObject (MusicKit_SoftLinking_MPCPlayerSeekCommand)
...
// NSObject (MusicKit_SoftLinking_MPCPlayerShuffleCommand)
...
// NSObject (RBSUtilities)

- (id)NSRepresentation;
- (bool)RBSIsXPCObject;

// NSObject (RBSXPCSecureCoding)
...
// NSObject (CRComputeDeviceAdditions)
...
// NSObject (ConformsToProtocolCached)
...
// NSObject (UIGestureRecognizer_Internal)
...
// NSObject (_UIKitIsUICollectionView)

- (bool)__isKindOfUICollectionView;

// NSObject (_UIKitIsUIRemoteViewController)

- (bool)__isKindOfUIRemoteViewController;

// NSObject (_UIKitIsUIResponder)

- (bool)__isKindOfUIResponder;

// NSObject (_UIKitIsUIScrollView)
...
// NSObject (_UIKitIsUIViewController)

- (bool)__isKindOfUIViewController;

// NSObject (_UITextSelectionRectKind)
...
// Image: /Library/Developer/CoreSimulator/Volumes/iOS_21A328/Library/Developer/CoreSimulator/Profiles/Runtimes/iOS 17.0.simruntime/Contents/Resources/RuntimeRoot/usr/lib/libRPAC.dylib
